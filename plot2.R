...
#R-script to create a png file with the PLOT 2
...
#A black line of the Global_active_power data
plot(hpc$Global_active_power~hpc$FullTime, type="l", ylab="Global Active Power (kilowatts)", xlab="")

#Saving plot2 to a png file
